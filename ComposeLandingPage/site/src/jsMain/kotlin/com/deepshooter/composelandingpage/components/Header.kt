...
import com.deepshooter.composelandingpage.styles.LogoStyle
import com.deepshooter.composelandingpage.styles.NavigationItemStyle
...
fun LeftSide(breakpoint: Breakpoint) {
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        ...
        if (breakpoint <= Breakpoint.MD) {
            FaBars(
                modifier = Modifier.margin(right = 15.px, bottom = 5.px),
                size = IconSize.XL
            )
        }
